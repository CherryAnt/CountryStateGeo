...
class Country extends Model
{
    ...
    public $translationForeignKey = 'csg_country_id';
    ...
    {
        return $this->belongsTo(CountryRegion::class, 'csg_region_id');
    }
    ...
    {
        return $this->hasMany(CountryGeographical::class, 'csg_country_id');
    }
